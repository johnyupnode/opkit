...
var (
	...
	fd_Reward_is_claimed protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Reward_is_claimed = md_Reward.Fields().ByName("is_claimed")
...
func (x *fastReflection_Reward) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.IsClaimed != false {
		...
		if !f(fd_Reward_is_claimed, value) {
			return
		}
	}
	if x.Amount != nil {
...
func (x *fastReflection_Reward) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "opkit.domain.Reward.domain":
		return x.Domain != ""
	case "opkit.domain.Reward.is_claimed":
...
func (x *fastReflection_Reward) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "opkit.domain.Reward.is_claimed":
		panic(fmt.Errorf("field is_claimed of message opkit.domain.Reward is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opkit.domain.Reward"))
		}
...
func (x *Reward) GetIsClaimed() bool {
	if x != nil {
		return x.IsClaimed
	}
	return false
...
var file_opkit_domain_reward_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x7f, 0x0a, 0x06, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x12, 0x16, 0x0a, 0x06,
	0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x6f,
	0x6d, 0x61, 0x69, 0x6e, 0x12, 0x24, 0x0a, 0x0a, 0x69, 0x73, 0x5f, 0x63, 0x6c, 0x61, 0x69, 0x6d,
	0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x42, 0x05, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52,
	0x09, 0x69, 0x73, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x12, 0x37, 0x0a, 0x06, 0x61, 0x6d,
	...
	0x75, 0x6e, 0x74, 0x42, 0x8f, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x70, 0x6b, 0x69,
	0x74, 0x2e, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x42, 0x0b, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64,
